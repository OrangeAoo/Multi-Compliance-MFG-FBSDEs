...
class Main_Models():
    ...
    def create(self, y0_model,yt1_model,zy_models,forward_loss=None,dB=None,init_x=None,init_c=None):
    ...
    def load_entire_models(self,path,overwrite=False):  
        ...
        if overwrite==True:
            self.model_dict=model_dict
            self.create(y0_model=model_dict['y0'],
                        yt1_model=model_dict['yt1'],
