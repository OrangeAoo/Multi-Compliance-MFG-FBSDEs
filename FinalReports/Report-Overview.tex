...
\usepackage{graphicx, setspace, xspace}
\usepackage[
    a4paper,
    left=25mm,
    top=25mm,
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[]{2024 Summer \hfill Research Overview}
\fancyfoot[R]{\thepage}
% \maketitle
% \medskip
...
\large
This is an overview of the 2024 summer research supervised by \ProfSC, who's dedication and guidance was sincerely appreciated.
\vspace{10pt}

For more math and algorithm details, please visit my GitHub repository the the link: \hyperlink{https://github.com/OrangeAoo/Multi-Period-Compliance-MFG-FBSDEs}{https://github.com/OrangeAoo/Multi-Period-Compliance-MFG-FBSDEs}. Should you find any problems, feel free to start an issue on \MyGitHub\ or directly reach out to me through \MyEmail\ (ya2538@columbia.edu).
