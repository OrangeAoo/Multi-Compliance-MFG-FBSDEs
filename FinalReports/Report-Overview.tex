...
implications and apply not only to the REC markets, but also in one's daily life.
\textit{\begin{itemize}
...
\begin{thebibliography}{9}
  \bibitem{SC}
  Campbell, Steven, et al. \href{https://doi.org/10.48550/arXiv.2110.01127}{"Deep learning for principal-agent mean field games."}arXiv preprint arXiv:2110.01127 (2021).
  
  \bibitem{RC}
  Carmona, René, and François Delarue. \href{https://arxiv.org/abs/1210.5780}{"Probabilistic analysis of mean-field games."} SIAM Journal on Control and Optimization 51.4 (2013): 2705-2734.

  \bibitem{JH}
  Han, J., Long, J. \href{https://doi.org/10.1186/s41546-020-00047-w}{"Convergence of the deep BSDE method for coupled FBSDEs."} Probab Uncertain Quant Risk 5, 5 (2020). 
\end{thebibliography}
